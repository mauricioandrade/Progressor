        ...
        <div className="space-y-4">
            ...
            <div className={tile}>
                <div className="flex items-center justify-between mb-3">
                    ...
                    {!editingGoal && (
                        <button onClick={() => { setEditingGoal(true); setGoalInput(weightGoal?.toString() ?? ''); }} className="w-6 h-6 flex items-center justify-center rounded-full bg-black/5 dark:bg-white/10 text-gray-400 hover:text-blue-500 transition-colors">
                            <Pencil className="w-3 h-3" />
                        </button>
                    )}
                </div>
                {editingGoal ? (
                    <div className="flex gap-1.5 items-center mb-3">
                        ...
                        <button onClick={handleSaveGoal} disabled={isSavingGoal} className="w-7 h-7 flex items-center justify-center rounded-xl bg-blue-500 text-white disabled:opacity-50"><Check className="w-3.5 h-3.5" /></button>
                        <button onClick={() => setEditingGoal(false)} className="w-7 h-7 flex items-center justify-center rounded-xl bg-black/10 dark:bg-white/10 text-gray-400"><X className="w-3.5 h-3.5" /></button>
                    </div>
                ) : weightGoal === null ? (
